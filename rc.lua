-- B. J. Potter's awesome window manager configuration
-- Lives in ~/.config/awesome
...
beautiful.init("/usr/share/awesome/themes/bjp/theme.lua")
...
mytextclock = awful.widget.textclock("%a, %Y-%m-%d %H:%M%z")
